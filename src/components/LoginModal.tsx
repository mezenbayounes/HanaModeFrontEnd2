...
export default function LoginModal({ isOpen, onClose, onLoginSuccess, onSwitchToRegister, onSwitchToForgotPassword, onSwitchToVerifyEmail, returnUrl }: LoginModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Then call success callback after a small delay to ensure modal is closed and auth state is updated
      setTimeout(() => {
        if (onLoginSuccess) {
          onLoginSuccess();
        }
  ...
  const handleGoogleLogin = () => {
    ...
    // If returnUrl is provided, encode it and append to the URL (optional, depending on backend support)
        ...
        >
          ...
          <div className="p-8">
            ...
            <div className="flex justify-center mb-4">
              <img src={hanaLogo} alt="Hana Mode Logo" className="h-24 w-auto object-contain" />
            </div>
